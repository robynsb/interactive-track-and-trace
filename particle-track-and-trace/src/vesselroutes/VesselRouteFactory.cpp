...
//  ));
  ...
  westIrelandToCopenHagen->addKeyPoint(3000000, -8.870830112476956, 54.453738054239466);
  westIrelandToCopenHagen->addKeyPoint(3000000, -8.870830112476956, 54.89230326581597);
  westIrelandToCopenHagen->addKeyPoint(3000000, -7.505610811486317, 55.59643925166461);
  westIrelandToCopenHagen->addKeyPoint(3000000, -6.097051215226138, 55.400045272739604);
  westIrelandToCopenHagen->addKeyPoint(3000000, -5.511957229087296, 54.85489741848255);
  westIrelandToCopenHagen->addKeyPoint(3000000, -5.381936343278664, 54.13757102528025);
  westIrelandToCopenHagen->addKeyPoint(3000000, -5.750328853069787, 53.97220358834105);
  westIrelandToCopenHagen->addKeyPoint(3000000, -5.858679591243647, 53.291181634245135);
  westIrelandToCopenHagen->addKeyPoint(3000000, -6.097051215226138, 52.229034344869945);
  westIrelandToCopenHagen->addKeyPoint(3000000, -5.251915457470032, 51.936064821361256);
  westIrelandToCopenHagen->addKeyPoint(3000000, -4.991873685852767, 51.35787829925067);
  westIrelandToCopenHagen->addKeyPoint(3000000, -3.9950468946532554, 51.30371827361402);
  westIrelandToCopenHagen->addKeyPoint(3000000, -4.948533390583223, 50.662537842698704);
  westIrelandToCopenHagen->addKeyPoint(3000000, -5.44694678618298, 50.359363543958025);
  westIrelandToCopenHagen->addKeyPoint(3000000, -6.703815348999755, 49.64904872099439);
  westIrelandToCopenHagen->addKeyPoint(3000000, -4.103397632827114, 50.08205953483051);
  westIrelandToCopenHagen->addKeyPoint(3000000, -3.2875160422166383, 50.29018864865551);
  westIrelandToCopenHagen->addKeyPoint(3000000, -3.1017853063448113, 50.60200057247842);
  westIrelandToCopenHagen->addKeyPoint(3000000, -2.409516199913458, 50.51082024238017);
  westIrelandToCopenHagen->addKeyPoint(3000000, -1.8860932170019453, 50.51082024238017);
  westIrelandToCopenHagen->addKeyPoint(3000000, -1.0080933746987648, 50.50008154738379);
  westIrelandToCopenHagen->addKeyPoint(3000000, -0.47622808561126134, 50.76247697504748);
  westIrelandToCopenHagen->addKeyPoint(3000000, 0.3764448381639425, 50.634139761722906);
  westIrelandToCopenHagen->addKeyPoint(3000000, 0.8324463709792884, 50.84130876040274);
  westIrelandToCopenHagen->addKeyPoint(3000000, 1.2415149841505717, 51.02066010055547);
  westIrelandToCopenHagen->addKeyPoint(3000000, 1.7793533719002474, 51.07100293572292);
  westIrelandToCopenHagen->addKeyPoint(3000000, 2.424043306590673, 51.17631863950783);
  westIrelandToCopenHagen->addKeyPoint(3000000, 2.918599968818946, 51.303484960874826);
  westIrelandToCopenHagen->addKeyPoint(3000000, 3.3513370482686837, 51.622605818976034);
